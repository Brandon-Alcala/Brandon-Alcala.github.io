...
to setup
  ...
  ;; set globals
  set k 2.3
  set threshold 0.1 + Feared/Hated-Rate / 10000
  if (Feared/Hated-Rate > 99) [
    set threshold 0.1 - Feared/Hated-Rate / 100
    ]
...
to determine-behavior
  set active? (grievance + (tax-Rate / 150) - risk-aversion * estimated-arrest-probability > threshold + (.7 * Safety2))
end

to-report grievance

  if (tax-Rate < 1) and (Feared/Hated-Rate = 75) [
    report (.15)
  ]
  if (Feared/Hated-Rate > 99) [
    report (.4 + Feared/Hated-Rate / 75)
  ]
  if (Tax-Rate > 99) [
    report (15 + (Tax-Rate * .01))
  ]
  if (tax-Rate > 60) and (Feared/Hated-Rate > 74) [
    report (.4 + (Feared/Hated-Rate / 75) + (Tax-Rate * .001))
  ]
  if (tax-Rate > 99) and (Safety > 99) and (Feared/Hated-Rate > 74) [
    report (15 + (tax-Rate))
  ]
  if (tax-Rate <= 25) and (Feared/Hated-Rate = 50) and (Safety >= 75) [
    report (.00000000001)
  ]
  if (Feared/Hated-Rate = 25) and (tax-Rate = 0) and (Safety = 100) [
    report (.001 + (Feared/Hated-Rate / 100))
  ]
   if (Feared/Hated-Rate = 75) and (tax-Rate = 25) and (Safety <= 25) [
    report (.1 + Safety)
   ]
  report (1 - (Feared/Hated-Rate / 65) + (Tax-Rate * .001))
end


to-report Safety2
  report Safety * (Safety / 30000)
  end
